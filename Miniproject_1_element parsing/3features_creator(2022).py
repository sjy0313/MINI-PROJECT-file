# -*- coding: utf-8 -*-
"""
Created on Tue Apr  9 16:52:43 2024
...
link1 = 'https://product.kyobobook.co.kr/bestseller/total?period=004#?page=1&per=50&period=004&ymw=2022&bsslBksClstCode=A'
link2 = 'https://product.kyobobook.co.kr/bestseller/total?period=004#?page=2&per=50&period=004&ymw=2022&bsslBksClstCode=A'
...
import pandas as pd
directory_loc = './project/book_info(2022).xlsx'
